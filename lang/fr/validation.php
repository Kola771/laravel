...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Messages de validation de la langue
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'lte' => [
        ...
        'string' => 'Le champ :attribute doit contenir moins ou être égal à :value caractères.',
    ],
    ...
    */
    ...
    | par quelque chose de plus convivial à lire, tel que "Adresse e-mail" au lieu de "email".
